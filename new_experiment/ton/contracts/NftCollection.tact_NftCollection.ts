...
export function loadNftCollection$Data(slice: Slice) {
    ...
    const _nft_item_code = sc_0.loadRef();
    return { $$type: 'NftCollection$Data' as const, owner: _owner, next_item_index: _next_item_index, collection_content: _collection_content, nft_item_code: _nft_item_code };
}
...
export function loadTupleNftCollection$Data(source: TupleReader) {
    ...
    const _nft_item_code = source.readCell();
    return { $$type: 'NftCollection$Data' as const, owner: _owner, next_item_index: _next_item_index, collection_content: _collection_content, nft_item_code: _nft_item_code };
}
...
async function NftCollection_init(owner: Address, next_item_index: bigint, collection_content: Cell, nft_item_code: Cell) {
    const __code = Cell.fromHex('b5ee9c7241010101004e000098ff00208e433030d072d721d200d200fa4021103450556f04f86101f862ed44d0d200019dfa40810101d700d4d455306c149ffa40810101d700d4d4553004d15502e25f04dcf2c082e1f2c80b1e5020d5');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initNftCollection_init_args({ $$type: 'NftCollection_init_args', owner, next_item_index, collection_content, nft_item_code })(builder);
...
const NftCollection_types: ABIType[] = [
    ...
    {"name":"NftCollection$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"next_item_index","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"collection_content","type":{"kind":"simple","type":"cell","optional":false}},{"name":"nft_item_code","type":{"kind":"simple","type":"cell","optional":false}}]},
]
...
export class NftCollection implements Contract {
    ...
    static async init(owner: Address, next_item_index: bigint, collection_content: Cell, nft_item_code: Cell) {
        return await NftCollection_init(owner, next_item_index, collection_content, nft_item_code);
    }
    
    static async fromInit(owner: Address, next_item_index: bigint, collection_content: Cell, nft_item_code: Cell) {
        const __gen_init = await NftCollection_init(owner, next_item_index, collection_content, nft_item_code);
